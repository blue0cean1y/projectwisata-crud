          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/team/sugengpt.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/team/sugengpt1.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-4">
              <div class="portfolio-info">
                <h3>Bio Pemandu</h3>
                <ul>
                  <li><strong>Nama</strong>: Sugeng Tinju</li>
                  <li><strong>umur</strong>: 16 tahun</li>
                  <li><strong>Kelas Pemandu</strong>: Swasta</li>
                </ul>
              </div>
